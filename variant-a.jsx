...
const VariantA = () => {
  ...
  return (
    <div style={{
      ...
      {/* HERO */}
      <section style={{ position: "relative", display: "grid", gridTemplateColumns: "1.05fr 1fr", gap: 56, alignItems: "center", marginBottom: 96 }}>
        <div>
          <div style={{
  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        <div ref={trackRef} style={{ position: "relative", display: "flex", alignItems: "center", gap: 2 }}>
          <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, paddingLeft: 6 }}>
          <a href="https://app.vyzor.fr" target="_blank" rel="noopener" style={{
